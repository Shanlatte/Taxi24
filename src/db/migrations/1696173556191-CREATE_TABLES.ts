...
export class CREATETABLES1696173556191 implements MigrationInterface {
    name = 'CREATETABLES1696173556191'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "invoice" ("id" SERIAL NOT NULL, "amount" numeric NOT NULL, "date" TIMESTAMP NOT NULL, "passengerId" integer, "driverId" integer, CONSTRAINT "PK_15d25c200d9bcd8a33f698daf18" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "invoice" ADD CONSTRAINT "FK_a8b208dcc8280d8271e9482fcab" FOREIGN KEY ("passengerId") REFERENCES "passenger"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoice" ADD CONSTRAINT "FK_387641d49267055f0903682fc8d" FOREIGN KEY ("driverId") REFERENCES "driver"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "invoice" DROP CONSTRAINT "FK_387641d49267055f0903682fc8d"`);
        await queryRunner.query(`ALTER TABLE "invoice" DROP CONSTRAINT "FK_a8b208dcc8280d8271e9482fcab"`);
